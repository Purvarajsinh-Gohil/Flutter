        ...
        child: Row(
          ...
          children: <Widget>[
            IconButton(
              ...
              onPressed: () async {
                await _launchURL("https://www.facebook.com/varianceinfotech/");
              },
            ),
            IconButton(
              icon: Icon(FontAwesomeIcons.twitter),
              onPressed: () async {
                await _launchURL("https://twitter.com/varianceinfo?lang=en");
              },
            ),
            IconButton(
              icon: Icon(FontAwesomeIcons.linkedinIn),
              onPressed: () async {
                _launchURL("https://in.linkedin.com/company/variance-infotech");
              },
            ),
            IconButton(
              icon: Icon(FontAwesomeIcons.youtube),
              onPressed: () async {
                await _launchURL("https://www.youtube.com/channel/UCjm7HjReEVKnZpeeZ8B_7Pg");
              },
            ),
            IconButton(
              icon: Icon(FontAwesomeIcons.meetup),
              onPressed: () async {
                await _launchURL("https://www.varianceinfotech.com/");
              },
            ),
            IconButton(
